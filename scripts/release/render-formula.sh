...
artifact_url="https://github.com/basetenlabs/openrouter-switch/releases/download/${tag}/${artifact_name}"
...
class OpenRouterSwitch < Formula
  ...
  homepage "https://github.com/basetenlabs/openrouter-switch"
  url "${artifact_url}"
  sha256 "${sha256}"
