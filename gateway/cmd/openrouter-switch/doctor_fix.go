// doctor_fix.go implements `openrouter-switch doctor --fix`, the interactive
...
// existing openrouter-switch verbs (the fixArgv attached to a check) as
...
const doctorFixGuardEnv = "OPENROUTER_SWITCH_DOCTOR_FIX"
