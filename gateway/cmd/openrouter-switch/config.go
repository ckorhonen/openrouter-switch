...
const configUsage = "usage: openrouter-switch config init [--force] | openrouter-switch config reset --yes [--preview-root PATH --router-addr HOST:PORT --door-addr HOST:PORT]"
