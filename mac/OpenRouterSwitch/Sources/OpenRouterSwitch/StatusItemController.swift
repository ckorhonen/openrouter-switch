...
final class StatusItemController: NSObject, NSMenuDelegate {
    ...
    init(state: OpenRouterSwitchState,
        ...
        statusItem.autosaveName = isPreview
            ? "openrouter-switch-fixture-\(ProcessInfo.processInfo.processIdentifier)"
    ...
    private func updateIconIfNeeded() {
        ...
        statusItem.button?.image = OpenRouterSwitchApp.menubarIcon(
            for: variant,
            state: projected)
    }
}
...
final class StatusMenuHeaderView: NSView {
    ...
    init(productName: String = "OpenRouter Switch",
         subtitle: String,
         isOn: Bool,
