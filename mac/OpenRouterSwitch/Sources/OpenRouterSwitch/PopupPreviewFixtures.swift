...
struct PopupPreviewFixture: Identifiable {
    static let environmentKey = "OPENROUTER_SWITCH_POPUP_PREVIEW"
    static let routerWindowEnvironmentKey = "OPENROUTER_SWITCH_ROUTER_WINDOW_PREVIEW"
    ...
    static let actionFailure = PopupPreviewFixture(
        ...
        stats: stats(),
        loginItemStatus: .enabled,
        lastError: "openrouter-switch not found (checked $OPENROUTER_SWITCH_GATEWAY_BIN, ~/.local/bin, brew opt paths)"
    )
