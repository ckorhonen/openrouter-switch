...
/// Extracts the version token from `openrouter-switch --version` output
/// ("openrouter-switch v0.2.1" -> "v0.2.1"). Unknown shapes pass through
...
/// openrouter-switch binary reports. An unknown router version renders as "?"
...
/// State of the global `openrouter-switch on|off` header switch. Disabled clients do
